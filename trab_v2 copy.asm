	...
	addiu 15    ; calcula endereco do comeco do laco
    addi 6
    add r1, r2
	st r0, r1   ; salva no endereco base + 1

    addiu 15
    addiu 12    ; calcula endereco do fim do laco
    add r1, r2
	st r0, r1   ; salva em endereco base + 2

	sub r1, r2
	mov r0, r1  ; deixa endereco base + 1 em r0 para facilitar a iteracao do laco
...
fim_loop:
    ...
    mov r3, r1  ; salva endereco base + 2 em r3 temporariamente

	ld r0, r1   ; recupera endereco do fim do laco anterior

	addiu 14    ; calcula endereco do comeco do laco da soma
	st r0, r1   ; salva na memoria em endereco base + 2

    addiu 15
    addiu 10    ; calcula endereco do fim do laco da soma 
	sub r1, r2
	st r0, r1   ; salva na memoria em endereco base + 1

	sub r1, r2  ; r1 volta a conter o endereco base 

    mov r0, r3  ; deixa endereco base + 2 em r0 para facilitar a iteracao do laco
